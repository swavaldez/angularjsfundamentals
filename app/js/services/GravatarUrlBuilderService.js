...
(function (app) {
    var services;
    (function (services) {
        var GravatarUrlBuilderService = /** @class */ (function () {
            function GravatarUrlBuilderService() {
            }
        ...
        services.GravatarUrlBuilderService = GravatarUrlBuilderService;
        app.eventApp.service("gravatarUrlBuilderService", GravatarUrlBuilderService);
